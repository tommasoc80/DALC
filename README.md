...
Messages can be retrieved using [Hydrator](https://github.com/DocNow/hydrator). However, since messages can be deleted by their authors, we make available a different version of the corpus, DALC full text:
