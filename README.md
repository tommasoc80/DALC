...
[comment]: <> However, since messages can be deleted by their authors, we make available a different version of the corpus, DALC full text:

[comment]: <>  - DALC full text v1.0 is available via this [link](https://forms.gle/RunFWuBjAHjwabe26)
[comment]: <>  - DALC full text v2.0 is available via this [link](https://forms.gle/NJD3E7CpsPSiCrMY8)

[comment]: <> DALC full text allows you to access the full text message. DALC full text is distributed with a dedicated licence. Please carefully check the extensions to the licence agreement that applies.
